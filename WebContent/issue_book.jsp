  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <section>
        ...
        <article>
        <h2>Search by</h2><br>
        <h4>Book name</h4> <input type="text" name="search" placeholder="Search..">><button type="button">Search</button><br>
        <h4>Author</h4><input type="text" name="search" placeholder="Search..">><button type="button">Search</button><br>
        <h4>ISBN</h4><input type="text" name="search" placeholder="Search..">><button type="button">Search</button><br>
        <h4>Publisher</h4><input type="text" name="search" placeholder="Search..">><button type="button">Search</button><br>
        </article>
<article>
          <!--link to the pending deliveries class-->
        <br>
        <br>  <h2><a href="Issue.html">Availabilty of Requested Books</a></h2>
        <br>
        <br>
          <table>
            <tr>
