...
<div  class="login-page">
  <div class="form">
    <form action="Register" method="post" onsubmit="return validateRegister()" > <!-- name="myform2" class="register-form"    -->
      
      <input type="text" placeholder="Student ID" name="student_id"/><span id="sid"></span>
...
<script type="text/javascript" >
	...
	function validateRegister(){  
		...
		var sid=document.myform2.student_id.value; 
		...
		if (sid==null || sid=="")
			{
			 document.getElementById("sid").innerHTML="Student Id can't be blank";k=1; 
			}
		if (name1==null || name1=="")
		{
